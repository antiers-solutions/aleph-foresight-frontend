/**
 * Contract ABI (Application Binary Interface) for Aleph Foresight smart contract.
 *
 * This contract provides a decentralized platform for event-based betting and prediction markets.
 *
 * @module AlephForesightContractAbi
 */
